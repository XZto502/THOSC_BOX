...
// Spell card features removed in main branch
            ...
            try {
                ...
                while (true) {
                    ...
                    if (now - lastPrintTime >= 500 || score != lastScore || cumulativeMisses != lastMiss || cumulativeBombs != lastBomb || rawStage != lastStageValue) {
                        print("\r[Live Data] Game: $gameNameWithDiff | Stage: $stageStr | Score: $score | Miss: $cumulativeMisses | Bomb: $cumulativeBombs        ")
                        System.out.flush()
                        lastPrintTime = now
                        lastScore = score
                    ...
                    if (now - lastChatboxTime >= 2000) {
                        val chatboxText = "Game: $gameNameWithDiff | Stage: $stageStr | Score: $score | Miss: $cumulativeMisses | Bomb: $cumulativeBombs"
